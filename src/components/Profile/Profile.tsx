...
function Profile() {
  return (
    <FadeInSection>
      <section id="profile" className="relative md:rounded-3xl md:shadow-lg md:dark:shadow-[0_8px_40px_8px_rgba(0,0,0,0.75)] md:max-w-lg lg:max-w-xl mx-auto overflow-hidden transition-all duration-300 bg-transparent md:bg-white md:dark:bg-[#0a0f1f]">
        ...
        <div className="relative flex flex-col p-4 xl:p-6 -mt-28 md:-mt-32">
          ...
          <div className="flex items-center space-x-4">
            <a
              ...
              className="group w-32 md:w-36 h-32 md:h-36 rounded-full border-5 border-gray-100 md:border-white dark:border-slate-900 md:dark:border-[#0a0f1f] overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-black/50 hover:scale-95"
            >
              <img
                src={profileImg}
                alt="Profile"
