...
function Profile() {
  return (
    <FadeInSection>
  <section id="profile" className="relative md:rounded-3xl md:shadow-lg md:dark:shadow-[0_8px_40px_8px_rgba(0,0,0,0.45)] md:max-w-lg lg:max-w-xl mx-auto overflow-hidden transition-all duration-700">
