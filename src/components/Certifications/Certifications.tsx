                ...
                >
                  <div className="flex items-center justify-between px-4 py-3">
                    <div className="flex items-center space-x-4">
                      ...
                      />
                      <div>
                        <h3 className="text-base lg:text-xl font-semibold text-gray-800 dark:text-white transition-colors duration-300">{cert.title}</h3>
                    ...
                    <span className="flex-shrink-0 flex items-center justify-center w-8 h-8 lg:w-10 lg:h-10">
                        <svg
                          className={`h-6 w-6 lg:h-8 lg:w-8 transition-all duration-300 ${isOpen ? "rotate-180" : ""} ${isOpen ? "fill-purple-500 dark:fill-purple-300" : "fill-gray-400 dark:fill-gray-600"}`}
