              ...
              <FadeInSection key={i}>
                <div
                  className={`scroll-mt-28 group rounded-lg border transition-all duration-300 cursor-pointer relative
                    ...
                    isOpen ? "border-amber-400 dark:border-amber-500 bg-amber-200 dark:bg-amber-900 shadow-lg" : "border-gray-200 dark:border-gray-800 bg-white dark:bg-[#0a0f1f]"}
                    ${!isComingSoon ? "hover:bg-amber-300 dark:hover:bg-amber-800 hover:border-amber-500" : ""} focus:outline-none`}
                  style={isComingSoon ? {
                        ...
                        <span
                          ...
                          className={
                            isComingSoon
                              ...
                              : isOpen
                              ? "bg-amber-100 dark:bg-amber-950 text-amber-800 dark:text-amber-200 text-xs md:text-sm font-medium px-3 py-1 rounded-full hover:bg-amber-400 dark:hover:bg-amber-900 transition-colors duration-300"
                              : "bg-amber-100 dark:bg-amber-950 text-amber-800 dark:text-amber-200 text-xs md:text-sm font-medium px-3 py-1 rounded-full hover:bg-amber-400 dark:hover:bg-amber-900 transition-colors duration-300"
                          }
                        >
                          {tag}
