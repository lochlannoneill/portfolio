            ...
            return (
              <FadeInSection key={i}>
                ...
                >
                  ...
                  <div
                    className={`transition-all duration-500 ease-in-out overflow-hidden px-4 md:px-6 ${isOpen ? 'opacity-100 pb-3 md:pb-4 space-y-3' : 'max-h-0 opacity-0 pb-0 space-y-0'}`}
                    style={{
