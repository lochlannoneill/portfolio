  ...
  return (
    <section id="education" className="w-full p-4 scroll-mt-16">
      <div className="max-w-5xl mx-auto">
        <FadeInSection>
          <h2 className="text-3xl text-center font-bold text-gray-800 dark:text-white mb-4 transition-colors duration-300">Education</h2>
        </FadeInSection>
              ...
              <FadeInSection key={i}>
                <div
                  className={`scroll-mt-28 group rounded-lg border transition-all duration-300 cursor-pointer relative
                    ...
                    isOpen ? "border-green-400 dark:border-green-500 bg-green-200 dark:bg-green-900 shadow-lg" : "border-gray-200 dark:border-gray-800 bg-white dark:bg-[#0a0f1f]"}
                ...
                >
                  ...
                  <div
                    className={`transition-all duration-800 ease-in-out overflow-hidden px-4 md:px-6 ${isOpen ? 'max-h-96 overflow-y-auto opacity-100 pb-3 md:pb-4 space-y-3 custom-scrollbar-green' : 'max-h-0 opacity-0 pb-0 space-y-0'}`}
                    style={{
